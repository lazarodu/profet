 ...
 */
class ProfessorCatController {
  /**
   * Show a list of all professorcats.
   * GET professorcats
   *
   * @param {object} ctx
  ...
  /**
   * Render a form to update an existing professorcat.
   * GET professorcats/:id/edit
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
